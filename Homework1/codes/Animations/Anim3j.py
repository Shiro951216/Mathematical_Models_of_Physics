...
class Anim3j(Scene):
    def construct(self):
        func_tex = (Tex(r"$\vec{\bf{v}} =  \cfrac{x}{ \sqrt{x^2+y^2} } \hat{\bf{i}} - \cfrac{y}{ \sqrt{x^2+y^2} } \hat{\bf{j}}$").
        ...
        stream = StreamLines(streamlines, x_range=[-7, 7, 0.4], y_range=[-4, 4, 0.3], padding=1, stroke_width=2)
