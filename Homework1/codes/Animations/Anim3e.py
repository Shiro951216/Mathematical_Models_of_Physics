...
class Anim3e(Scene):
    def construct(self):
        func_tex = (Tex(r"$\vec{\bf{v}} = x \hat{\bf{i}} - y \hat{\bf{j}}$").to_edge(UL).add_background_rectangle(BLACK))
        ...
        stream = StreamLines(streamlines, x_range=[-7, 7, 0.4], y_range=[-7, 7, 0.3], padding=1)
