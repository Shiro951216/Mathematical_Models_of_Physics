...
class Anim3l(Scene):
    def construct(self):
        func_tex = (Tex(r"$\vec{\bf{v}} =  \cos{x} \hat{\bf{i}} +  \sin{y} \hat{\bf{j}}$").
        ...
        stream = StreamLines(streamlines, x_range=[-10, 10, 0.4], y_range=[-8, 8, 0.3], padding=1, stroke_width=2)
